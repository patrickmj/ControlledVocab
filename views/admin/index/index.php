...
<a class="browse" href="<?php echo uri('controlled-vocab/vocabs/browse') ?>">Browse All</a>
...
<div>
<h1>Terms</h1>
<a class="browse" href="<?php echo uri('controlled-vocab/terms/browse') ?>">Browse All</a>
